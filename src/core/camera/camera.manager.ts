...
export class CameraManager {
   constructor(
      ...
      controller.resize$.subscribe((size) =>
         component.setAspectRatio(size.x / size.y)
      );
      cameraController.quaternion$.subscribe((quaternion) =>
         component.setQuaternion(quaternion)
      );
      movement.position$.subscribe((position) =>
